...
- Set via HUD selector in `LeverageSelector.tsx`
...
// Leverage types
import type { LeverageOption } from '@/game/types/trading'
```
...
- `.claude/rules/game-design.md` - Game mechanics and leverage system
